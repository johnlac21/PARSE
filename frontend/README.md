...
│       │   └── page.tsx
│       ├── run/                   # Select model, start run, progress
│       │   └── page.tsx
...
- **grammar-panel**, **typo-panel**, **dialect-panel**: Select features and options; trigger applicability check and variant generation.
- **variant-preview**: Shows sample variants before generating.

### Analysis
- **run-selector**: Multi-select which runs to include in analysis (completed runs).
